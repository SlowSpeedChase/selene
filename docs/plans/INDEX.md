...
|------|----------|-------|-------|
| 2026-05-28 | [2026-05-28-leverage-rollout-plan.md](2026-05-28-leverage-rollout-plan.md) | roadmap, planning, gitops | Sequencing plan (not a feature design). Orders the 8 competitive-scan lessons into 3 waves + executable per-feature checklists for the two Ready docs (#1 digest lead, #6 note→task proposer) mapped to GitOps stages, plus a "how to resume" guide. Start: Wave 1 #1, then Wave 2 #6. |

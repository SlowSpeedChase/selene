...
- [System map](guides/features/system-map.md) — one always-correct page (`docs/SYSTEM-MAP.md`) showing every workflow, its schedule, and what it reads/writes; generated from the code so it can't go stale.

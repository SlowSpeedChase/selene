...
class ChromaStore:
    ...
    async def initialize(self) -> VectorStoreResult:
        ...
        try:
            ...
            return VectorStoreResult(
                ...
                data={"collection_name": self.collection_name, "db_path": str(self.db_path)},
    ...
    async def add_document(self, 
                          ...
                          doc_id: Optional[str] = None) -> VectorStoreResult:
        """
        ...
        try:
            ...
            embedding_result = await self.embedding_service.generate_single_embedding(content)
    ...
    async def search(self, 
                    query: str, 
                    n_results: int = 5,
                    where: Optional[Dict[str, Any]] = None) -> VectorStoreResult:
        """
        ...
        try:
            ...
            embedding_result = await self.embedding_service.generate_single_embedding(query)
            if not embedding_result.success:
                return VectorStoreResult(
                    success=False,
